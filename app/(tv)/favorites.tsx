...
import { Heart, User, LogIn } from 'lucide-react-native';
    ...
    <View style={s.container}>
      ...
      <View style={s.contentWrapper}>
        <Animated.View entering={FadeIn.duration(600)} style={s.header}>
          <Heart size={36} color={Colors.accent} fill="rgba(0,229,255,0.15)" strokeWidth={2.5} />
        ...
        {!user ? (
          <View style={s.center}>
            <Animated.View entering={FadeInDown.duration(600)} style={s.emptyCard}>
              ...
              <Text style={s.emptySubtitle}>Debes estar autenticado para poder agregar y visualizar tus películas y series favoritas.</Text>
          ...
          <View style={s.center}>
            <Animated.View entering={FadeInDown.duration(600)} style={s.emptyCard}>
              <Heart size={64} color="rgba(255,255,255,0.15)" style={{ marginBottom: 20 }} />
              <Text style={s.emptyTitle}>Tu lista está vacía</Text>
              <Text style={s.emptySubtitle}>Agrega películas o series desde sus detalles presionando el botón "Mi Lista" para encontrarlas rápidamente aquí.</Text>
            </Animated.View>
          </View>
        )}
      </View>
...
const s = StyleSheet.create({
  ...
  contentWrapper: {
    flex: 1,
    paddingTop: 140, // Match profile/header offset
